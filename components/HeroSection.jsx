...
function HeroSection() {
  ...
  return (
    <>
      <div id="home" className='hero-section w-screen h-auto  flex items-center justify-evenly p-6 bg-black '>
        <Spotlight />
        <div className='hero-section-1 max-w-lg flex flex-col gap-2 text-white mt-48'>
